...
|Process environmental data layers to within your training region, Sample background points within your training region, Partition a dataset for an ecological niche model
