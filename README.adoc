...
// Crowdin badge
https://crowdin.com/project/data-use[image:https://badges.crowdin.net/data-use/localized.svg[Crowdin]]

= GBIF Course Data-Use

_This is information *about* this course's source code.  It is not part of the document._

The course is available as HTML and PDF at https://docs.gbif.org/course-data-use/[Course Data Use].
