...
The IUCN Red List of Categories and Criteria were developed for applying at a global level i.e. to take into account a species entire global distribution that may cross internation borders. However, you may want to asses the extinction risk of a species at a regional, national or local level and in these instances you may want to use the link:https://www.gbif.org/publishing-data[Guidelines for Application of IUCN Red List Criteria at Regional and National Levels^], an adaptation of the global Categories and Criteria that provide additional guidance on:

- Deciding on which species should be assessed at a regional, national or local level
- Additional criteria for assessments at a regional, national and a local level
- Asessing breeding vs non-breeding species at a regional, national and a local level
- Assessing species at a regional, national and a local level with information for the species across its global distribution.
...
A full overview of these minimum documentation requirements and mapped Darwin Core fields can be found, respectively, in the mapping standards guidelines and as a downloadable Excel file on the link:https://www.iucnredlist.org/resources/mappingstandards[IUCN Mapping Standards] webpage. 
